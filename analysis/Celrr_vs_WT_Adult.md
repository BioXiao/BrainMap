...
Genes:
![plot of chunk CV_genes](figure/Celrr/Adult/CV_genes.png) 


Isoforms: 
![plot of chunk cv_iso](figure/Celrr/Adult/cv_iso.png) 
...
![plot of chunk volcano_matrix](figure/Celrr/Adult/volcano_matrix.png) 
...
## Scatterplot
![plot of chunk scatterplot](figure/Celrr/Adult/scatterplot.png) 
...
![plot of chunk boxplot_genes](figure/Celrr/Adult/boxplot_genes.png) 

Boxplot (genes, replicates)

![plot of chunk boxplot_genes_replicates](figure/Celrr/Adult/boxplot_genes_replicates.png) 

Boxplot (isoforms)

![plot of chunk boxplot_isoforms](figure/Celrr/Adult/boxplot_isoforms.png) 

Boxplot (isoforms, replicates)

![plot of chunk boxplot_isoforms_replicates](figure/Celrr/Adult/boxplot_isoforms_replicates.png) 

### Density

Density (genes)

![plot of chunk density](figure/Celrr/Adult/density.png) 

Density (genes, replicates)

![plot of chunk density_w_replicates](figure/Celrr/Adult/density_w_replicates.png) 


## Clustering

### Replicate Clusters
![plot of chunk replicate_clusters](figure/Celrr/Adult/replicate_clusters.png) 

```
## 'dendrogram' with 2 branches and 17 members total, at height 0.07545
```

### PCA (genes)
![plot of chunk PCA](figure/Celrr/Adult/PCA.png) 

### MDS (genes)
![plot of chunk MDS](figure/Celrr/Adult/MDS.png) 
...
![plot of chunk Enodenous_lncRNA_tables](figure/Celrr/Adult/Enodenous_lncRNA_tables.png) 

Endogenous expression of Celrr isoforms:

![plot of chunk endogenous_iso](figure/Celrr/Adult/endogenous_iso.png) 

Barplot of gene expression:

![plot of chunk endogenous_barplot](figure/Celrr/Adult/endogenous_barplot.png) 

Barplot of isoform expression:

![plot of chunk endogenous_iso_barplot](figure/Celrr/Adult/endogenous_iso_barplot.png) 


## LacZ expression

![plot of chunk LacZ_expression](figure/Celrr/Adult/LacZ_expression1.png) ![plot of chunk LacZ_expression](figure/Celrr/Adult/LacZ_expression2.png) 


## Digital Genotyping (LacZ vs Endogenous lncRNA and Sex)
Expression plot (endogenous linc, lacZ, Y-expressed gene):

![plot of chunk Digital_Genotyping](figure/Celrr/Adult/Digital_Genotyping.png) 

Expression heatmap:
![plot of chunk digital_geno_heatmap](figure/Celrr/Adult/digital_geno_heatmap.png) 
...
![plot of chunk sigMatrix](figure/Celrr/Adult/sigMatrix.png) 

### Significant gene expression differences between conditions

Expression plot (genes):
![plot of chunk sigExpression](figure/Celrr/Adult/sigExpression1.png) ![plot of chunk sigExpression](figure/Celrr/Adult/sigExpression2.png) 

Significant genes with expression >50fpkm (any condition):
![plot of chunk highly_expressed_sig](figure/Celrr/Adult/highly_expressed_sig.png) 
...
![plot of chunk diff_iso](figure/Celrr/Adult/diff_iso.png) 
...
![plot of chunk print_GSEA_biocarta](figure/Celrr/Adult/print_GSEA_biocarta.png) 

![plot of chunk print_GSEA_reactome](figure/Celrr/Adult/print_GSEA_reactome.png) 
...
![plot of chunk GO_figures](figure/Celrr/Adult/GO_figures1.png) ![plot of chunk GO_figures](figure/Celrr/Adult/GO_figures2.png) ![plot of chunk GO_figures](figure/Celrr/Adult/GO_figures3.png) ![plot of chunk GO_figures](figure/Celrr/Adult/GO_figures4.png) ![plot of chunk GO_figures](figure/Celrr/Adult/GO_figures5.png) 
...
![plot of chunk overlap_image](figure/Celrr/Adult/overlap_image.png) 

# Notes

## Samples used are:
<!-- html table generated in R 3.0.2 by xtable 1.7-3 package -->
<!-- Sat Jun 21 16:31:34 2014 -->
<TABLE border=1>
