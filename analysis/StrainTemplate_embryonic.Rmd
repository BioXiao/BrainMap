...
```{r plot ALL OF THE SIGNIFICANT GENES, fig.height=(20 + (1*(length(sig)))), fig.width=(20 + (1*length(sig)))}
...
# how do we rescale these plots? or just axes?
```{r print all the splicing csPie plots, fig.height=(20 +1*length(splicingSigIDs)), fig.width=(20 +1*length(splicingSigIDs))}
...
```{r GO analysis setup and functions,echo=FALSE,eval=TRUE}
...
```{r GO figures, echo=FALSE,  fig.height=5, fig.width=8}
