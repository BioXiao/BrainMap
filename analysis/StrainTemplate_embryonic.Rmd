...
dir<-"/n/rinn_data1/users/agroff/seq/PERIL/data/diffs/cuffdiff_v221_newgtf/Kidney/"
...
## Differential Genes
There are `r length(sigGenes)` significantly differentially expressed genes. They are:
```{r sigdiffGenetable}
