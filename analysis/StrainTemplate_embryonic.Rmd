...
```{r plot ALL OF THE SIGNIFICANT GENES, fig.height=20, fig.width=20}
...
heatmap.2(x, trace="none", margins=c(5,30), col=InputCols, labRow=labels,dendrogram="both",lhei =c(0.9,0.1))
#dev.off()
```
...
heatmap.2(x, trace="none", margins=c(5,30),col=InputCols,dendrogram="both",lhei = c(0.9,0.10))
#dev.off()
```
