...
x<-(-log10(t(biocarta_pvl_corrected[,which(colMins(biocarta_pvl_corrected) < 0.0000001)])))

heatmap.2(x, trace="none", margins=c(5,30), col=InputCols,dendrogram="row",lhei =c(0.1,0.9),key=FALSE, cexRow = (0.2 + .5/log10(dim(x)[1])), labCol=c(""))
...
heatmap.2(x, trace="none", margins=c(5,30),col=InputCols,dendrogram="both",lhei = c(0.1,0.90), key=FALSE,cexRow = (0.2 + .5/log10(dim(x)[1])), labCol=c(""))
dev.off()
```
