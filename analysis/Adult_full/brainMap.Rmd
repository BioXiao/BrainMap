...
sigMatrix(cuff,level='genes') + scale_fill_gradient(limits=c(0,300),low="white",high="darkgreen")
sigMatrix(cuff,level='isoforms') + scale_fill_gradient(limits=c(0,300),low="white",high="darkred")
sigMatrix(cuff,level='CDS') + scale_fill_gradient(limits=c(0,300),low="white",high="purple")
dev.off()
