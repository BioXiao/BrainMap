...
![plot of chunk R distance heatmap](figure/peril_kidney/R distance heatmap1.png) 

```r
csDistHeat(genes(cuff), replicates=T)
```

![plot of chunk R distance heatmap](figure/peril_kidney/R distance heatmap2.png) 
...
![plot of chunk sigMatrix](figure/peril_kidney/sigMatrix1.png) 
...
![plot of chunk sigMatrix](figure/peril_kidney/sigMatrix2.png) 
...
![plot of chunk unnamed-chunk-4](figure/peril_kidney/unnamed-chunk-41.png) 
...
![plot of chunk unnamed-chunk-4](figure/peril_kidney/unnamed-chunk-42.png) 
...
![plot of chunk diff.TSS](figure/peril_kidney/diff.TSS1.png) 
...
![plot of chunk diff.TSS](figure/peril_kidney/diff.TSS2.png) 
...
![plot of chunk unnamed-chunk-5](figure/peril_kidney/unnamed-chunk-5.png) 
