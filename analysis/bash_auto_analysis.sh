...
#linc-cox2 15 and 16
sbatch -J R_auto -t 600 --mem-per-cpu=7000 -n 4 -p general --wrap="Rscript runScript.R 15"
sbatch -J R_auto -t 600 --mem-per-cpu=7000 -n 4 -p general --wrap="Rscript runScript.R 16"

#haunt 7
sbatch -J R_auto -t 600 --mem-per-cpu=7000 -n 4 -p general --wrap="Rscript runScript.R 7"
