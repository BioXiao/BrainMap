...
```{r sigGenes logfoldchange_heatmap}
...
```{r isoform_heatmap, fig.height=10, fig.width=8}
if(length(isoformSigIDs)>0){
...
```{r isoform logfoldchange_heatmap}
if(length(isoformSigIDs)>0){
...
heatmap.2(x_ordered, trace="none", margins=c(5,20),col=InputCols,dendrogram="both",lhei = c(0.1,0.90), labCol=c(""))
