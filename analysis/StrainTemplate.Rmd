...
setwd(dir)
cuff<-readCufflinks(dir=dir,gtfFile="/n/rinn_data1/seq/lgoff/Projects/BrainMap/data/annotation/mm10_gencode_vM2_with_lncRNAs_and_LacZ.gtf",genome="mm10",rebuild=T)
...
gene_names<-merge(annotation,population.diff,by="gene_id")
...
get_gene_set_p_vals <- function(input, gs, alternative){
  gene_set_indices <- lapply(gs$genesets, function(gene_set){
    gene_set_index(gene_set,input$short_name)
    })
