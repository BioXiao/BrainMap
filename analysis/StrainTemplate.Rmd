...
strain<-"Kdm5c"
timepoint<-"Adult"
filename<-"Embryo_WT_male_v_female"
dir<-"/n/rinn_data1/seq/lgoff/Projects/BrainMap/data/diffs/WT_Embryonic_Male_v_Female/"
...
```{r computationally intensive part of cis trans image, eval=FALSE}
...
```{r cisreg_image,  fig.height=8, fig.width=8, eval=FALSE}
