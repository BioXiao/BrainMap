...
dir<-"/n/rinn_data1/seq/lgoff/Projects/BrainMap/data/olddiffs/linc-Cox2_vs_WT_Embryonic/"
...
#setwd(dir)
cuff<-readCufflinks(dir=dir,gtfFile=GTF,genome=genome) #rebuild=T until all first rounds done! build sep though bc issues :-/
...
doPlot(genome=genome, name=strain, myChr=chrom, from=from, to=to, window=20,bamFiles=bamFiles, bamNames=bamNames, koStart=koStart,koWidth=koWidth,koChr=koChr)
