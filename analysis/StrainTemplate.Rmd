...
strain<-"linc-Brn1b"
timepoint<-"Adult"
filename<-"linc-Brn1b_vs_WT_Embryonic"
...
```{r cellcycle, fig.width=10, fig.height=12}
...
cellcycle.p<-ggplot(cellcycle.melt)+geom_tile(aes(x=variable,y=gene_short_name,fill=value))+facet_grid(Stage~.,space="free_y",scales="free")+theme_bw()+scale_fill_gradient2(low="blue",mid="white",high="red",limits=limits)

cellcycple.p<-cellcycle.p+theme(axis.text.x=element_text(angle=-90,hjust=0))+guides(color=FALSE)


cellcycle.p<-cellcycle.p+geom_tile(aes(x=variable,y=gene_short_name,color=significant),fill="#FFFFFF00",size=1)+scale_color_manual(values=c("#FFFFFF00","black"))+coord_equal(1)
...
```{r cortical layers, fig.width=10, fig.height=12}
...
cortical.p<-ggplot(cortical.melt)+geom_tile(aes(x=variable,y=gene_short_name,fill=value))+facet_grid(Layer~.,space="free_y",scales="free")+theme_bw()+scale_fill_gradient2(low="blue",mid="white",high="red",limits=limits)

cortical.p<-cortical.p+theme(axis.text.x=element_text(angle=-90,hjust=0))+guides(color=FALSE)


cortical.p<-cortical.p+geom_tile(aes(x=variable,y=gene_short_name,color=significant),fill="#FFFFFF00",size=1)+scale_color_manual(values=c("#FFFFFF00","black"))+coord_equal(1)
...
```{r neural cell types, fig.width=10, fig.height=12}
...
neuralcelltype.p<-ggplot(neuralcelltype.melt)+geom_tile(aes(x=variable,y=gene_short_name,fill=value))+facet_grid(Cell_type~.,space="free_y",scales="free")+theme_bw()+scale_fill_gradient2(low="blue",mid="white",high="red",limits=limits)

neuralcelltype.p<-neuralcelltype.p+theme(axis.text.x=element_text(angle=-90,hjust=0))+guides(color=FALSE)


neuralcelltype.p<-neuralcelltype.p+geom_tile(aes(x=variable,y=gene_short_name,color=significant),fill="#FFFFFF00",size=1)+scale_color_manual(values=c("#FFFFFF00","black"))+coord_equal(1)
...
```{r neural diff markers, fig.width=10, fig.height=12}
...
ndiff.p<-ggplot(ndiff.melt)+geom_tile(aes(x=variable,y=gene_short_name,fill=value))+facet_grid(Cell_type~.,space="free_y",scales="free")+theme_bw()+scale_fill_gradient2(low="blue",mid="white",high="red",limits=limits)

ndiff.p<-ndiff.p+theme(axis.text.x=element_text(angle=-90,hjust=0))+guides(color=FALSE)

ndiff.p<-ndiff.p+geom_tile(aes(x=variable,y=gene_short_name,color=significant),fill="#FFFFFF00",size=1)+scale_color_manual(values=c("#FFFFFF00","black"))+coord_equal(1)
ndiff.p
