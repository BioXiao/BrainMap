...
#region: chr1:42,699,046-42,777,639
...
brn1acoords<-strsplit(coords,":")
brn1acoords<-unlist(coords)
brn1akoChr<-coords[1]
...
brn1b<-"linc-Brn1b"
brn1bcoords<-deletionCoords[which(deletionCoords$gene_name==brn1a),3]
brn1bcoords<-strsplit(coords,":")
brn1bcoords<-unlist(coords)
brn1bkoChr<-coords[1]
positions<-strsplit(coords[[2]],"-")
positions<-unlist(positions)
...
```{r strain_track_vis}
  ...
  myTracks<-c(idxTrack,axTrack,genetrack,bamTracks,brn1akoTrack,brn1bkoTrack)
