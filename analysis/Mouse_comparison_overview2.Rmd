...
heatmap.2(xx_ordered, Rowv=FALSE, breaks=15, dendrogram="none", Colv=FALSE, sepwidth=c(.9,.9),trace="none", col=InputCols, lhei=c(.5,.5))
...
ggplot(linc_LZ_correlation, aes(LZ,EndogenousLinc,color=timepoint))+geom_point()+geom_text(aes(label=name))+scale_x_log10(limits=c(-20,50))+scale_y_log10(limits=c(-20,30))
#+xlim(-.1,.5)+ylim(-.1,.5)
