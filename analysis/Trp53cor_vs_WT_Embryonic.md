...
![plot of chunk boxplot genes](figure/Trp53cor/boxplot genes.png) 

Boxplot (genes, replicates)

![plot of chunk boxplot genes replicates](figure/Trp53cor/boxplot genes replicates.png) 

Boxplot (isoforms)

![plot of chunk boxplot isoforms](figure/Trp53cor/boxplot isoforms.png) 

Boxplot (isoforms, replicates)

![plot of chunk boxplot isoforms replicates](figure/Trp53cor/boxplot isoforms replicates.png) 
...
## Warning: Removed 5638 rows containing non-finite values (stat_density).
```

![plot of chunk density](figure/Trp53cor/density.png) 
Density (genes, replicates)

```
## Warning: Removed 6675 rows containing non-finite values (stat_density).
## Warning: Removed 7003 rows containing non-finite values (stat_density).
## Warning: Removed 6665 rows containing non-finite values (stat_density).
## Warning: Removed 6661 rows containing non-finite values (stat_density).
## Warning: Removed 6659 rows containing non-finite values (stat_density).
## Warning: Removed 6925 rows containing non-finite values (stat_density).
## Warning: Removed 6925 rows containing non-finite values (stat_density).
## Warning: Removed 6978 rows containing non-finite values (stat_density).
## Warning: Removed 6969 rows containing non-finite values (stat_density).
## Warning: Removed 6936 rows containing non-finite values (stat_density).
## Warning: Removed 7398 rows containing non-finite values (stat_density).
## Warning: Removed 7320 rows containing non-finite values (stat_density).
## Warning: Removed 7686 rows containing non-finite values (stat_density).
...
![plot of chunk density w replicates](figure/Trp53cor/density w replicates.png) 
...
<TR> <TH>  </TH> <TH> isoform_id </TH> <TH> sample_name </TH> <TH> fpkm </TH> <TH> conf_hi </TH> <TH> conf_lo </TH> <TH> quant_status </TH>  </TR>
  <TR> <TD align="right"> 1 </TD> <TD> LacZ </TD> <TD> Peril </TD> <TD align="right"> 24.56 </TD> <TD align="right"> 30.10 </TD> <TD align="right"> 19.02 </TD> <TD> OK </TD> </TR>
  <TR> <TD align="right"> 2 </TD> <TD> LacZ </TD> <TD> WT </TD> <TD align="right"> 0.02 </TD> <TD align="right"> 0.06 </TD> <TD align="right"> 0.00 </TD> <TD> OK </TD> </TR>
   </TABLE>
![plot of chunk Enodenous lncRNA tables](figure/Trp53cor/Enodenous lncRNA tables1.png) ![plot of chunk Enodenous lncRNA tables](figure/Trp53cor/Enodenous lncRNA tables2.png) 

Endogenous expression of Trp53cor isoforms:
![plot of chunk endogenous iso](figure/Trp53cor/endogenous iso1.png) ![plot of chunk endogenous iso](figure/Trp53cor/endogenous iso2.png) 

Barplot of gene expression:
![plot of chunk endogenous barplot](figure/Trp53cor/endogenous barplot1.png) ![plot of chunk endogenous barplot](figure/Trp53cor/endogenous barplot2.png) 

Barplot of isoform expression:
![plot of chunk endogenous iso barplot](figure/Trp53cor/endogenous iso barplot1.png) ![plot of chunk endogenous iso barplot](figure/Trp53cor/endogenous iso barplot2.png) 


## LacZ expression
<!-- html table generated in R 3.0.2 by xtable 1.7-3 package -->
<!-- Sun Jun 15 23:40:01 2014 -->
<TABLE border=1>
<TR> <TH>  </TH> <TH> gene_id </TH> <TH> sample_name </TH> <TH> fpkm </TH> <TH> conf_hi </TH> <TH> conf_lo </TH> <TH> quant_status </TH>  </TR>
...
![plot of chunk Digital Genotyping](figure/Trp53cor/Digital Genotyping.png) 
...
![plot of chunk digital geno heatmap](figure/Trp53cor/digital geno heatmap.png) 
...
![plot of chunk sigExpression](figure/Trp53cor/sigExpression1.png) 
...
![plot of chunk sigExpression](figure/Trp53cor/sigExpression2.png) 
...
![plot of chunk highly expressed sig](figure/Trp53cor/highly expressed sig.png) 
