...
### Boxplot
![plot of chunk boxplot](figure/linc-Brn1b/boxplot1.png) ![plot of chunk boxplot](figure/linc-Brn1b/boxplot2.png) ![plot of chunk boxplot](figure/linc-Brn1b/boxplot3.png) 

### Density

```
## Warning: Removed 3902 rows containing non-finite values (stat_density).
## Warning: Removed 5464 rows containing non-finite values (stat_density).
```

![plot of chunk density](figure/linc-Brn1b/density1.png) 
...
## Warning: Removed 7136 rows containing non-finite values (stat_density).
## Warning: Removed 6447 rows containing non-finite values (stat_density).
## Warning: Removed 6500 rows containing non-finite values (stat_density).
```

![plot of chunk density](figure/linc-Brn1b/density2.png) 
...
<!-- html table generated in R 3.0.2 by xtable 1.7-3 package -->
<!-- Sun Jun 15 20:19:45 2014 -->
<TABLE border=1>
<TR> <TH>  </TH> <TH> gene_id </TH> <TH> sample_name </TH> <TH> fpkm </TH> <TH> conf_hi </TH> <TH> conf_lo </TH> <TH> quant_status </TH>  </TR>
  <TR> <TD align="right"> 1 </TD> <TD> ENSMUSG00000097063.2 </TD> <TD> WT </TD> <TD align="right"> 1.23 </TD> <TD align="right"> 3.68 </TD> <TD align="right"> 0.00 </TD> <TD> OK </TD> </TR>
...
<TR> <TH>  </TH> <TH> isoform_id </TH> <TH> sample_name </TH> <TH> fpkm </TH> <TH> conf_hi </TH> <TH> conf_lo </TH> <TH> quant_status </TH>  </TR>
  <TR> <TD align="right"> 1 </TD> <TD> ENSMUST00000180589.1 </TD> <TD> WT </TD> <TD align="right"> 1.23 </TD> <TD align="right"> 3.68 </TD> <TD align="right"> 0.00 </TD> <TD> OK </TD> </TR>
  <TR> <TD align="right"> 2 </TD> <TD> ENSMUST00000180589.1 </TD> <TD> linc_Brn1b </TD> <TD align="right"> 0.00 </TD> <TD align="right"> 0.13 </TD> <TD align="right"> 0.00 </TD> <TD> OK </TD> </TR>
   </TABLE>
![plot of chunk Enodenous lncRNA tables](figure/linc-Brn1b/Enodenous lncRNA tables1.png) ![plot of chunk Enodenous lncRNA tables](figure/linc-Brn1b/Enodenous lncRNA tables2.png) ![plot of chunk Enodenous lncRNA tables](figure/linc-Brn1b/Enodenous lncRNA tables3.png) ![plot of chunk Enodenous lncRNA tables](figure/linc-Brn1b/Enodenous lncRNA tables4.png) ![plot of chunk Enodenous lncRNA tables](figure/linc-Brn1b/Enodenous lncRNA tables5.png) ![plot of chunk Enodenous lncRNA tables](figure/linc-Brn1b/Enodenous lncRNA tables6.png) ![plot of chunk Enodenous lncRNA tables](figure/linc-Brn1b/Enodenous lncRNA tables7.png) ![plot of chunk Enodenous lncRNA tables](figure/linc-Brn1b/Enodenous lncRNA tables8.png) 


## LacZ expression
<!-- html table generated in R 3.0.2 by xtable 1.7-3 package -->
<!-- Sun Jun 15 20:19:54 2014 -->
<TABLE border=1>
<TR> <TH>  </TH> <TH> gene_id </TH> <TH> sample_name </TH> <TH> fpkm </TH> <TH> conf_hi </TH> <TH> conf_lo </TH> <TH> quant_status </TH>  </TR>
  ...
  <TR> <TD align="right"> 2 </TD> <TD> Velocigene_LacZ </TD> <TD> linc_Brn1b </TD> <TD align="right"> 6.02 </TD> <TD align="right"> 7.24 </TD> <TD align="right"> 4.81 </TD> <TD> OK </TD> </TR>
   </TABLE>
...
![plot of chunk Digital Genotyping](figure/linc-Brn1b/Digital Genotyping1.png) 
...
![plot of chunk Digital Genotyping](figure/linc-Brn1b/Digital Genotyping2.png) 
...
![plot of chunk Digital Genotyping](figure/linc-Brn1b/Digital Genotyping3.png) 
...
![plot of chunk sigExpression](figure/linc-Brn1b/sigExpression1.png) ![plot of chunk sigExpression](figure/linc-Brn1b/sigExpression2.png) 
...
![plot of chunk sigExpression](figure/linc-Brn1b/sigExpression3.png) 
