...
Genes:
![plot of chunk CV_genes](Eldr_vs_WT_Adult/figure/CV_genes.png) 
...
![plot of chunk volcano_matrix](Eldr_vs_WT_Adult/figure/volcano_matrix.png) 
...
## Scatterplot
![plot of chunk scatterplot](Eldr_vs_WT_Adult/figure/scatterplot.png) 
...
![plot of chunk boxplot_genes](Eldr_vs_WT_Adult/figure/boxplot_genes.png) 

Boxplot (genes, replicates)

![plot of chunk boxplot_genes_replicates](Eldr_vs_WT_Adult/figure/boxplot_genes_replicates.png) 

Boxplot (isoforms)

![plot of chunk boxplot_isoforms](Eldr_vs_WT_Adult/figure/boxplot_isoforms.png) 

Boxplot (isoforms, replicates)

![plot of chunk boxplot_isoforms_replicates](Eldr_vs_WT_Adult/figure/boxplot_isoforms_replicates.png) 

### Density

Density (genes)

![plot of chunk density](Eldr_vs_WT_Adult/figure/density.png) 

Density (genes, replicates)

![plot of chunk density_w_replicates](Eldr_vs_WT_Adult/figure/density_w_replicates.png) 


## Clustering

### Replicate Clusters
![plot of chunk replicate_clusters](Eldr_vs_WT_Adult/figure/replicate_clusters.png) 
...
### PCA (genes)
![plot of chunk PCA](Eldr_vs_WT_Adult/figure/PCA.png) 

### MDS (genes)
![plot of chunk MDS](Eldr_vs_WT_Adult/figure/MDS.png) 
...
![plot of chunk Enodenous_lncRNA_tables](Eldr_vs_WT_Adult/figure/Enodenous_lncRNA_tables.png) 

Endogenous expression of Eldr isoforms:

![plot of chunk endogenous_iso](Eldr_vs_WT_Adult/figure/endogenous_iso.png) 

Barplot of gene expression:

![plot of chunk endogenous_barplot](Eldr_vs_WT_Adult/figure/endogenous_barplot.png) 

Barplot of isoform expression:

![plot of chunk endogenous_iso_barplot](Eldr_vs_WT_Adult/figure/endogenous_iso_barplot.png) 


## LacZ expression

![plot of chunk LacZ_expression](Eldr_vs_WT_Adult/figure/LacZ_expression1.png) ![plot of chunk LacZ_expression](Eldr_vs_WT_Adult/figure/LacZ_expression2.png) 


## Digital Genotyping (LacZ vs Endogenous lncRNA and Sex)
Expression plot (endogenous linc, lacZ, Y-expressed gene):

![plot of chunk Digital_Genotyping](Eldr_vs_WT_Adult/figure/Digital_Genotyping.png) 

Expression heatmap:
![plot of chunk digital_geno_heatmap](Eldr_vs_WT_Adult/figure/digital_geno_heatmap.png) 
...
![plot of chunk sigMatrix](Eldr_vs_WT_Adult/figure/sigMatrix.png) 

### Significant gene expression differences between conditions

Expression plot (genes):
![plot of chunk sigExpression](Eldr_vs_WT_Adult/figure/sigExpression1.png) ![plot of chunk sigExpression](Eldr_vs_WT_Adult/figure/sigExpression2.png) 

Significant genes with expression >50fpkm (any condition):
![plot of chunk highly_expressed_sig](Eldr_vs_WT_Adult/figure/highly_expressed_sig.png) 
...
![plot of chunk diff_iso](Eldr_vs_WT_Adult/figure/diff_iso.png) 
...
![plot of chunk isoform_heatmap](Eldr_vs_WT_Adult/figure/isoform_heatmap.png) 
...
![plot of chunk GO_figures](Eldr_vs_WT_Adult/figure/GO_figures1.png) ![plot of chunk GO_figures](Eldr_vs_WT_Adult/figure/GO_figures2.png) ![plot of chunk GO_figures](Eldr_vs_WT_Adult/figure/GO_figures3.png) 

```
## Error: need finite 'xlim' values
```

![plot of chunk GO_figures](Eldr_vs_WT_Adult/figure/GO_figures4.png) 
...
![plot of chunk overlap_image](Eldr_vs_WT_Adult/figure/overlap_image.png) 

# Notes

## Samples used are:
<!-- html table generated in R 3.0.2 by xtable 1.7-3 package -->
<!-- Mon Jun 23 23:08:50 2014 -->
<TABLE border=1>
