...
ggplot(linc_LZ_correlation, aes(EndogenousLinc,LZ,color=timepoint))+geom_point()+geom_text(aes(label=paste(name,timepoint,sep="_")))+xlab("Endogenous lincRNA expression (FPKM)")+ylab("LacZ expression (FPKM)")+coord_trans(x="log10",y="log10")+geom_abline(intercept=0,slope=1)
...
ggplot(linc_LZ_correlation, aes(EndogenousLinc,ActinInKOs,color=timepoint))+geom_point()+geom_text(aes(label=name))+geom_abline(intercept=0,slope=1)+xlab("Endogenous lincRNA expression (FPKM)")+ylab("Actin expression (FPKM)")+coord_trans(x="log10",y="log10")+coord_cartesian(xlim=c(-10,900))

ggsave("linc_Actin.pdf")


ggplot(linc_LZ_correlation, aes(LZ,ActinInKOs,color=timepoint))+geom_point()+geom_text(aes(label=name))+geom_abline(intercept=0,slope=1)+xlab("LacZ expression (FPKM)")+ylab("Actin expression (FPKM)")+coord_trans(x="log10",y="log10")+coord_cartesian(xlim=c(-10,900))
