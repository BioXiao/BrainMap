...
celrr_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
crnde_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
eldr_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
haunt_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
kantr_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
brn1a_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
brn1b_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
lincCox2_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
lincEnc1_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
manr_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
Peril_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
trp53cor1_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
tug1_adult_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
cellr_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
crnde_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
eldr_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
haunt_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
kantr_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
lincbrn1b_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
lincCox2_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
lincEnc1_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
manr_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
Peril_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
trp53cor1_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
DEgenes<-getGenes(cuff,sig)
tug1_embryo_DE<-annot(DEgenes)$gene_short_name
rm(DEgenes)
...
heatmap.2(xx_ordered, Rowv=FALSE, breaks=15, dendrogram="none", Colv=FALSE, sepwidth=c(.9,.9),trace="none", col=myColors,breaks=myBreaks, lhei=c(.5,.5))
