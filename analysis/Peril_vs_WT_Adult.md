...
### Boxplot
![plot of chunk boxplot](figure/Peril/boxplot1.png) ![plot of chunk boxplot](figure/Peril/boxplot2.png) ![plot of chunk boxplot](figure/Peril/boxplot3.png) 

### Density

```
## Warning: Removed 3902 rows containing non-finite values (stat_density).
## Warning: Removed 5418 rows containing non-finite values (stat_density).
```

![plot of chunk density](figure/Peril/density1.png) 
...
## Warning: Removed 6561 rows containing non-finite values (stat_density).
## Warning: Removed 6577 rows containing non-finite values (stat_density).
## Warning: Removed 6697 rows containing non-finite values (stat_density).
```

![plot of chunk density](figure/Peril/density2.png) 
...
![plot of chunk Enodenous lncRNA tables](figure/Peril/Enodenous lncRNA tables1.png) ![plot of chunk Enodenous lncRNA tables](figure/Peril/Enodenous lncRNA tables2.png) ![plot of chunk Enodenous lncRNA tables](figure/Peril/Enodenous lncRNA tables3.png) ![plot of chunk Enodenous lncRNA tables](figure/Peril/Enodenous lncRNA tables4.png) ![plot of chunk Enodenous lncRNA tables](figure/Peril/Enodenous lncRNA tables5.png) ![plot of chunk Enodenous lncRNA tables](figure/Peril/Enodenous lncRNA tables6.png) ![plot of chunk Enodenous lncRNA tables](figure/Peril/Enodenous lncRNA tables7.png) ![plot of chunk Enodenous lncRNA tables](figure/Peril/Enodenous lncRNA tables8.png) 


## LacZ expression
<!-- html table generated in R 3.0.2 by xtable 1.7-3 package -->
<!-- Sun Jun 15 20:36:31 2014 -->
<TABLE border=1>
<TR> <TH>  </TH> <TH> gene_id </TH> <TH> sample_name </TH> <TH> fpkm </TH> <TH> conf_hi </TH> <TH> conf_lo </TH> <TH> quant_status </TH>  </TR>
...
![plot of chunk Digital Genotyping](figure/Peril/Digital Genotyping1.png) 
...
![plot of chunk Digital Genotyping](figure/Peril/Digital Genotyping2.png) 
...
![plot of chunk Digital Genotyping](figure/Peril/Digital Genotyping3.png) 
...
![plot of chunk sigExpression](figure/Peril/sigExpression1.png) ![plot of chunk sigExpression](figure/Peril/sigExpression2.png) 
...
![plot of chunk sigExpression](figure/Peril/sigExpression3.png) 
