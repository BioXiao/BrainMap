...
Genes:
![plot of chunk CV_genes](figure/Haunt/Adult/CV_genes.png) 


Isoforms: 
![plot of chunk cv_iso](figure/Haunt/Adult/cv_iso.png) 
...
![plot of chunk volcano_matrix](figure/Haunt/Adult/volcano_matrix.png) 
...
## Scatterplot
![plot of chunk scatterplot](figure/Haunt/Adult/scatterplot.png) 
...
![plot of chunk boxplot_genes](figure/Haunt/Adult/boxplot_genes.png) 

Boxplot (genes, replicates)

![plot of chunk boxplot_genes_replicates](figure/Haunt/Adult/boxplot_genes_replicates.png) 

Boxplot (isoforms)

![plot of chunk boxplot_isoforms](figure/Haunt/Adult/boxplot_isoforms.png) 

Boxplot (isoforms, replicates)

![plot of chunk boxplot_isoforms_replicates](figure/Haunt/Adult/boxplot_isoforms_replicates.png) 

### Density

Density (genes)

![plot of chunk density](figure/Haunt/Adult/density.png) 

Density (genes, replicates)

![plot of chunk density_w_replicates](figure/Haunt/Adult/density_w_replicates.png) 


## Clustering

### Replicate Clusters
![plot of chunk replicate_clusters](figure/Haunt/Adult/replicate_clusters.png) 
...
### PCA (genes)
![plot of chunk PCA](figure/Haunt/Adult/PCA.png) 

### MDS (genes)
![plot of chunk MDS](figure/Haunt/Adult/MDS.png) 
...
![plot of chunk Enodenous_lncRNA_tables](figure/Haunt/Adult/Enodenous_lncRNA_tables.png) 

Endogenous expression of Haunt isoforms:

![plot of chunk endogenous_iso](figure/Haunt/Adult/endogenous_iso.png) 

Barplot of gene expression:

![plot of chunk endogenous_barplot](figure/Haunt/Adult/endogenous_barplot.png) 

Barplot of isoform expression:

![plot of chunk endogenous_iso_barplot](figure/Haunt/Adult/endogenous_iso_barplot.png) 


## LacZ expression

![plot of chunk LacZ_expression](figure/Haunt/Adult/LacZ_expression1.png) ![plot of chunk LacZ_expression](figure/Haunt/Adult/LacZ_expression2.png) 


## Digital Genotyping (LacZ vs Endogenous lncRNA and Sex)
Expression plot (endogenous linc, lacZ, Y-expressed gene):

![plot of chunk Digital_Genotyping](figure/Haunt/Adult/Digital_Genotyping.png) 

Expression heatmap:
![plot of chunk digital_geno_heatmap](figure/Haunt/Adult/digital_geno_heatmap.png) 
...
![plot of chunk sigMatrix](figure/Haunt/Adult/sigMatrix.png) 

### Significant gene expression differences between conditions

Expression plot (genes):
![plot of chunk sigExpression](figure/Haunt/Adult/sigExpression1.png) ![plot of chunk sigExpression](figure/Haunt/Adult/sigExpression2.png) 

Significant genes with expression >50fpkm (any condition):
![plot of chunk highly_expressed_sig](figure/Haunt/Adult/highly_expressed_sig.png) 
...
![plot of chunk diff_iso](figure/Haunt/Adult/diff_iso.png) 
...
![plot of chunk isoform_heatmap](figure/Haunt/Adult/isoform_heatmap.png) 
...
![plot of chunk print_GSEA_biocarta](figure/Haunt/Adult/print_GSEA_biocarta.png) 

![plot of chunk print_GSEA_reactome](figure/Haunt/Adult/print_GSEA_reactome.png) 
...
![plot of chunk GO_figures](figure/Haunt/Adult/GO_figures1.png) ![plot of chunk GO_figures](figure/Haunt/Adult/GO_figures2.png) 
...
![plot of chunk GO_figures](figure/Haunt/Adult/GO_figures3.png) 
...
![plot of chunk overlap_image](figure/Haunt/Adult/overlap_image.png) 

# Notes

## Samples used are:
<!-- html table generated in R 3.0.2 by xtable 1.7-3 package -->
<!-- Sat Jun 21 17:48:05 2014 -->
<TABLE border=1>
...
<TR> <TH>  </TH> <TH> file </TH> <TH> sample_name </TH> <TH> replicate </TH> <TH> rep_name </TH> <TH> total_mass </TH> <TH> norm_mass </TH> <TH> internal_scale </TH> <TH> external_scale </TH>  </TR>
  ...
  <TR> <TD align="right"> 8 </TD> <TD> /n/rinn_data1/seq/lgoff/Projects/BrainMap/data/quants/JR778/abundances.cxb </TD> <TD> WT </TD> <TD align="right">   7 </TD> <TD> WT_7 </TD> <TD align="right"> 39549100.00 </TD> <TD align="right"> 34088800.00 </TD> <TD align="right"> 1.17 </TD> <TD align="right"> 1.00 </TD> </TR>
