...
### Boxplot
![plot of chunk boxplot](figure/Haunt/boxplot1.png) ![plot of chunk boxplot](figure/Haunt/boxplot2.png) ![plot of chunk boxplot](figure/Haunt/boxplot3.png) 

### Density

```
## Warning: Removed 3902 rows containing non-finite values (stat_density).
## Warning: Removed 5645 rows containing non-finite values (stat_density).
```

![plot of chunk density](figure/Haunt/density1.png) 
...
## Warning: Removed 7149 rows containing non-finite values (stat_density).
## Warning: Removed 6589 rows containing non-finite values (stat_density).
## Warning: Removed 6832 rows containing non-finite values (stat_density).
```

![plot of chunk density](figure/Haunt/density2.png) 
...
![plot of chunk Enodenous lncRNA tables](figure/Haunt/Enodenous lncRNA tables1.png) ![plot of chunk Enodenous lncRNA tables](figure/Haunt/Enodenous lncRNA tables2.png) ![plot of chunk Enodenous lncRNA tables](figure/Haunt/Enodenous lncRNA tables3.png) ![plot of chunk Enodenous lncRNA tables](figure/Haunt/Enodenous lncRNA tables4.png) ![plot of chunk Enodenous lncRNA tables](figure/Haunt/Enodenous lncRNA tables5.png) ![plot of chunk Enodenous lncRNA tables](figure/Haunt/Enodenous lncRNA tables6.png) ![plot of chunk Enodenous lncRNA tables](figure/Haunt/Enodenous lncRNA tables7.png) ![plot of chunk Enodenous lncRNA tables](figure/Haunt/Enodenous lncRNA tables8.png) 


## LacZ expression
<!-- html table generated in R 3.0.2 by xtable 1.7-3 package -->
<!-- Sun Jun 15 20:07:27 2014 -->
<TABLE border=1>
<TR> <TH>  </TH> <TH> gene_id </TH> <TH> sample_name </TH> <TH> fpkm </TH> <TH> conf_hi </TH> <TH> conf_lo </TH> <TH> quant_status </TH>  </TR>
...
![plot of chunk Digital Genotyping](figure/Haunt/Digital Genotyping1.png) 
...
![plot of chunk Digital Genotyping](figure/Haunt/Digital Genotyping2.png) 
...
![plot of chunk Digital Genotyping](figure/Haunt/Digital Genotyping3.png) 
...
![plot of chunk sigExpression](figure/Haunt/sigExpression1.png) ![plot of chunk sigExpression](figure/Haunt/sigExpression2.png) 
...
![plot of chunk sigExpression](figure/Haunt/sigExpression3.png) 
...
![plot of chunk GO figures](figure/Haunt/GO figures1.png) ![plot of chunk GO figures](figure/Haunt/GO figures2.png) ![plot of chunk GO figures](figure/Haunt/GO figures3.png) ![plot of chunk GO figures](figure/Haunt/GO figures4.png) ![plot of chunk GO figures](figure/Haunt/GO figures5.png) 
